...
(function (global, factory) {
  ...
  async function eonitem () {
    ...
    let state = {
      ...
      helpmsg: ` 
      will create stripe site
  
      usage:
        > cls&&node ./scripts/run eodoes-eodo-stripe ../eosites eoparse --doc --view
        > node ./scripts/run eodoes-eodo-stripe ../eosites --author sifbuilder --pwdgit ______ eoclear uncode eoparse eogit eohub netify --doc --view --debug
  `,
