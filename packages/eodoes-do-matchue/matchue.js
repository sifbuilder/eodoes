...
;(function (global, factory) { // eslint-disable-line no-extra-semi
  ...
  async function eonitem (__eo = {}) {
    ...
    let state = {
      ...
      > node ./scripts/run eodoes-do-matchue ../eosites eoparse --doc --gcp gcp501
      > node ./scripts/run eodoes-do-matchue ../../.. eoparse --eon e --doc
      > node ~/c/e/c/eodoes/scripts/run.js eodoes-do-matchue  ~/e/c/eodoes/eosites eoparse --doc --gcp gcp501
      > ~/c/e/c/eosites/eodoes-eo-matchue/resolve.sh

      https://colab.research.google.com/github/sifbuilder/eodoes/blob/master/packages/eodoes-do-matchue/code/AdaptiveInstanceNormalization.ipynb
      https://colab.research.google.com/github/sifbuilder/eodoes/blob/master/packages/eodoes-do-matchue/code/Vanilla_GAN.ipynb
