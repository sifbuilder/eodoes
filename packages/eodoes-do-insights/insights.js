...
;(function (global, factory) { // eslint-disable-line no-extra-semi
  ...
  async function eonitem (__eo = {}) {
    ...
    let state = {
      ...
      > node ./scripts/run eodoes-do-insights ../eosites eoparse --doc --gcp gcp501
      > node ./scripts/run eodoes-do-insights ../../.. eoparse --eon e --doc
      > node ~/c/e/c/eodoes/scripts/run.js eodoes-do-insights  ~/e/c/eodoes/eosites eoparse --doc --gcp gcp501
      > ~/c/e/c/eosites/eodoes-eo-insights/resolve.sh

      resfs: 
      
        https://www.youtube.com/redirect?redir_token=V1Gx8wU6XmNHNQuwhrtCFDjzUsl8MTU3MTQxNzQ5NUAxNTcxMzMxMDk1&v=dCKbRCUyop8&q=https%3A%2F%2Fdrive.google.com%2Fopen%3Fid%3D1LBWcmnUPoHDeaYlRiHokGyjywIdyhAQb&event=video_description
        ...
        StyleGan Encoder - ResNet model
        Original image -> predicted from ResNet -> final encoded
                          trained on generated

        train resnet.py - to predict latent representations
        pre-trained model - data finetuned - resnet.h5

        train-effnet.py - EfficientNet-based encoder
                          predict latent representations of images in StyleGan

        encode-images.py  Find latent representation of reference images

        align-images.py   Align faces
 `,
