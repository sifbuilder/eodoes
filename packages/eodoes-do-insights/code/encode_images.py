...
def main():
    ...
    parser.add_argument('--model_path', default='karras2019stylegan-ffhq-1024x1024.pkl', help='Read a StyleGAN model to train on from file') # karras2019stylegan-ffhq-1024x1024.pkl
    ...
    parser.add_argument('--pkl_path', default='vgg16_zhang_perceptual.pkl', help='Read a StyleGAN model to train on from file') # vgg16_zhang_perceptual.pkl
    parser.add_argument('--pkl_url', default='https://drive.google.com/uc?id=1N2-m9qszOeVC9Tq77WxsLnuWwOedQiD2') # vgg16_zhang_perceptual.pkl
    ...
    # _e_
    model_uri=args.model_url
    if args.model_path:
        model_uri=args.model_path

    with dnnlib.util.open_url(model_uri, cache_dir=config.cache_dir) as f:
    ...
    # _e_
    pkl_uri=args.pkl_url
    if args.pkl_path:
        pkl_uri=args.pkl_path

    perc_model = None
    if (args.use_lpips_loss > 0.00000001):
        perc_model =  load_pkl(pkl_uri)
